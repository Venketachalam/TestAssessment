...
extension String {
    ...
    var ls:String {
        let tableNameForTranslation = "Localizable"
    ...
    func getReadableDate() -> String {
        ...
        let formattedString = dateFormatter.string(from: tempDate!)
     ...
     func selectedStringToDateFormat(date:String)->String{
        let dateFormatter=DateFormatter()
        dateFormatter.dateFormat="MMM dd,yyyy"
         let dateAccess = dateFormatter.date(from: date)
        dateFormatter.dateFormat="dd-MMM-yyyy"
        let convertedDate=dateFormatter.string(for:dateAccess)
        return convertedDate ?? ""
    }
    
    func serverDateFormatToMedium() -> String {
        
        let dateFormatter=DateFormatter()
        dateFormatter.dateFormat = "dd-MMM-yy"//"yyyy-MM-dd HH:mm:ss.S"
        let dateAccess = dateFormatter.date(from: self)
        dateFormatter.dateFormat="MMM d,yyyy"
        let convertedDate=dateFormatter.string(for:dateAccess)
        return convertedDate ?? ""
    }
    
    func serverDateFormatToNormal() -> String {
        
        let dateFormatter=DateFormatter()
        dateFormatter.dateFormat = "dd-MMM-yyyy"//"yyyy-MM-dd HH:mm:ss.S"
        let dateAccess = dateFormatter.date(from: self)
        dateFormatter.dateFormat="dd/MM/yyyy"
        let convertedDate=dateFormatter.string(for:dateAccess)
        return convertedDate ?? ""
    ...
    func heightWithConstrainedWidth(_ width: CGFloat, font: UIFont) -> Int {
    ...
    var removeDuplicateWhiteSpaces : String {
    ...
    func stripSpacesAndNewLineCharacter() -> String {
    ...
    func formatDigits(formatter : NumberFormatter) -> String{
        
        let planeString = self.replacingOccurrences(of: ",", with: "", options: .literal, range: nil)
        var formatedString : String!
        if let myInteger = Int(planeString) {
            let myNumber = NSNumber(value:myInteger)
            formatedString = formatter.string(from: myNumber)
        }else {
            formatedString = self
        }
    ...
    func removedCurrencyFormat() -> String{
        return self.replacingOccurrences(of: ",", with: "", options: .literal, range: nil)
        
    }

    
    func heightForLabelText(font:UIFont, width:CGFloat, lineSpacing : CGFloat) -> CGFloat
    {
    ...
    func getAttributeString(color:UIColor,font:UIFont? = nil) -> NSAttributedString {
    ...
    func getUnderLineAttributeString(color:UIColor,font:UIFont? = nil) -> NSAttributedString {
        let attribute = [ NSAttributedString.Key.foregroundColor: color,.underlineStyle: NSUnderlineStyle.single.rawValue ] as [NSAttributedString.Key : Any]
        let attrString = NSMutableAttributedString(string: self, attributes: attribute)
        return attrString
...
extension NSAttributedString {
    ...
    func joinedString(string:NSAttributedString) -> NSMutableAttributedString {
